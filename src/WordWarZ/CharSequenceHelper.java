...
/**
* WordWarZ/CharSequenceHelper.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from C:/Users/frances/2025-9444-team6_finproject_java/src/GameService.idl
* Monday, May 5, 2025 10:08:27 PM CST
*/

abstract public class CharSequenceHelper
{
  private static String  _id = "IDL:WordWarZ/CharSequence:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (WordWarZ.CharSequenceHelper.id (), "CharSequence", __typeCode);
    }
    return __typeCode;
  }
